            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 18),
                  _mealRow(Icons.breakfast_dining, 'Frühstück', day['breakfast']!),
    ...
    showDialog(
      ...
      TextButton.icon(
        onPressed: () {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Download-Funktion wird als nächstes aktiviert'),
            ),
          );
        },
  ...
  Future<void> addDailyReport() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Tagesbericht wurde gespeichert'),
          ),
        );
      }
    } catch (e) {
